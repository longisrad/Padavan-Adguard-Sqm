...
ifneq (,$(filter y,$(CONFIG_FIRMWARE_INCLUDE_ZAPRET) \
                   $(CONFIG_FIRMWARE_INCLUDE_NFQWS) \
                   $(CONFIG_FIRMWARE_INCLUDE_NFQWS2) \
                   $(CONFIG_FIRMWARE_INCLUDE_ZAPRET2)))
CFLAGS += -DAPP_ZAPRET
endif
...
ifeq ($(CONFIG_FIRMWARE_INCLUDE_AGH),y)
CFLAGS += -DAPP_ADGUARD
endif

ifeq ($(CONFIG_FIRMWARE_SQM_UI),y)
CFLAGS += -DSQM_WEBUI
endif
