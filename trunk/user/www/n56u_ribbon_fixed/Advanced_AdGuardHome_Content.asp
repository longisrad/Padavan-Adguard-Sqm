                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
                                    ...
                                    <div class="alert alert-info" style="margin: 10px;">
                                        <#AdGuardHome_Desc#>
                                        <a href="https://adguard.com/en/adguard-home/overview.html" target="blank">AdGuard Home</a>
                                    </div>
                                            ...
                                            <td>
                                                <div class="main_itoggle">
                                                    <div id="agh_enabled_on_of">
                                                        <input type="checkbox" id="agh_enabled_fake"
                                                            <% nvram_match_x("","agh_enabled","1","value=1 checked"); %>
                                                            <% nvram_match_x("","agh_enabled","0","value=0"); %>>
                                                    </div>
                                                </div>
                                                <div style="position:absolute;margin-left:-10000px;">
                                                    <input type="radio" value="1" name="agh_enabled" id="agh_enabled_1"
                                                        <% nvram_match_x("","agh_enabled","1","checked"); %>><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="agh_enabled" id="agh_enabled_0"
                                                        <% nvram_match_x("","agh_enabled","0","checked"); %>><#checkbox_No#>
                                                </div>
                                            </td>
                                            <td colspan="2" style="border-top:0 none;">
                                                <input class="btn btn-success" type="button"
                                                    value="<#AdGuardHome_WebIf#>"
                                                    onclick="button_AdGuardHome_wan_port()" tabindex="24">
                                            </td>
                                        </tr>
                                            ...
                                            <td>
                                                <div class="main_itoggle">
                                                    <div id="adguard_replace_dns_on_of">
                                                        <input type="checkbox" id="adguard_replace_dns_fake"
                                                            <% nvram_match_x("","adguard_replace_dns","1","value=1 checked"); %>
                                                            <% nvram_match_x("","adguard_replace_dns","0","value=0"); %>>
                                                    </div>
                                                </div>
                                                <div style="position:absolute;margin-left:-10000px;">
                                                    <input type="radio" value="1" name="adguard_replace_dns" id="adguard_replace_dns_1"
                                                        <% nvram_match_x("","adguard_replace_dns","1","checked"); %>><#checkbox_Yes#>
                                                    <input type="radio" value="0" name="adguard_replace_dns" id="adguard_replace_dns_0"
                                                        <% nvram_match_x("","adguard_replace_dns","0","checked"); %>><#checkbox_No#>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr id="adguard_port">
                                            <th><#AdGuardHome_Port#></th>
                                            <td>
                                                <input type="text" maxlength="64" class="input" size="64"
                                                    name="adguard_port"
                                                    value="<% nvram_get_x("","adguard_port"); %>" />
                                            </td>
                                        </tr>
                                        <tr>
